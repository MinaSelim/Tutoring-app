...
export const HomeUI = (props) => {
    ...
    const name = JSON.parse(JSON.stringify(store.getState().SignInReducer.firstName).replace(/(\{|,)\s*(.+?)\s*:/g, '$1 "$2":'));
    ...
    return (
      ...
      <View style={styles.background}>
        ...
        <View style={styles.middleSection}>
          ...
          <Button style={[styles.button, {top: 25}]} onPress={() => props.navigation.navigate('TutorSearch')}>Find a tutor</Button>
          <Button style={[styles.button, {top: 30}]} onPress={()=>props.navigation.navigate("StudyGroupSearch")}>Find a study group</Button>
          <UniversityImage/>
      </View>
